...
<div class="card col-10 m-auto">
    ...
    <div class="card-body">
        <form action="{{ route('admin.product.update', $product->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <x-input type="text" name="name" id="name" label="Product Name" :value="$product->name"/>
                </div>
                <div class="col-lg-6">
                    <x-input type="text" name="color" id="color" label="Product Color" :value="$product->color"/>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-6">
                    <x-input type="text" name="condition" id="condition" label="Product Condition" :value="$product->condition"/>
                </div>
                <div class="col-lg-6">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" value="1" id="sold" name="sold" {{ $product->sold ? 'checked' : '' }}>
